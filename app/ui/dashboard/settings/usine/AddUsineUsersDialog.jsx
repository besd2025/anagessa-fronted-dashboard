...
export default function AddUsersUsineDialog() {
        ...
        async function loadInitialData() {
            try {
                const [provData, socData] = await Promise.all([
                    ...
                    fetchData("get", `mais/usine_deparchage/get_all_usine/`, { params: { offset: 0, limit: 12 } })
                ]);
    ...
    const handleSubmit = async (e) => {
        ...
        //   category: "Anagessa_Chef_societe" // Ensuring category is set for Chef de Société
        // };
        const FormData = {
        ...
        try {
            const response = await fetchData("post", `mais/registration_udp/`, {
                body: FormData,
            });
